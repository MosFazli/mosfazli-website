      ...
      <div class="communication-box">
        ...
        <div id="emailSVG">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="40"
               height="40" viewBox="0 0 40 40" xml:space="preserve">

<defs>
</defs>
            <g style="stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: none; fill-rule: nonzero; opacity: 1;"
               transform="translate(1.4065934065934016 1.4065934065934016) scale(0.4 0.4)">
	<circle cx="45" cy="45" r="45"
        ...
        <div id="emailContact">
          <h3>Email:</h3>
          <a href="mailto:mosfazli@gmail.com">mosfazli@gmail.com</a>
        </div>
...
<defs>
	...
	<circle cx="45" cy="45" r="45"
      ...
      <nav>
        <router-link to="/"><h1 id="topButtonMain" class="button">Home</h1></router-link>
      </nav>
...
.message-box .user-box textarea:focus ~ label,
.message-box .user-box textarea:valid ~ label {
  top: -20px;
  left: 0;
  color: #03e9f4;
  font-size: 12px;
